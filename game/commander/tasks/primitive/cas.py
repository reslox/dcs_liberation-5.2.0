...
from game.commander.tasks.primitive.AImodify import casflights, tarcapflights
...
class PlanCas(PackagePlanningTask[FrontLine]):
    ...
    def propose_flights(self) -> None:
        self.propose_flight(FlightType.CAS, casflights)
        self.propose_flight(FlightType.TARCAP, tarcapflights)
